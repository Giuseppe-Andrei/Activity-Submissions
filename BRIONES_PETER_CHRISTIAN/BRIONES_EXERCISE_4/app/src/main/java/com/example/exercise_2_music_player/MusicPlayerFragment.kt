...
class MusicPlayerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        favoriteButton.setOnClickListener {
            if (currentSongData.isNotEmpty()) {
                listener?.onToggleFavorite(currentSongData)
                updateFavoriteIcon()
            }
        }
    ...
    private fun updateFavoriteIcon() {
        if (currentSongData.isNotEmpty() && listener?.isFavorite(currentSongData) == true) {
            favoriteButton.setImageResource(R.drawable.favorite) // Filled favorite icon
        } else {
            favoriteButton.setImageResource(R.drawable.favorite) // Outline favorite icon
        }
    }
